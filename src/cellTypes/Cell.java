...
public abstract class Cell {
	...
	public abstract Cell makeNewCell(int cellX, int cellY, int cellState, IEdgeStrategy edgeStrategy, Map<String, Double> cellParameterMap, Map<Integer, Color> cellColorMap, int[] xDelta, int[] yDelta);
